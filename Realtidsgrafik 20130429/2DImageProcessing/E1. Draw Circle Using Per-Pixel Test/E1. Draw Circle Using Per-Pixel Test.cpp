...
{
public:
	CirclePerPixelTestRenderer(int centerX, int centerY, float radius, FloatRGBColor insideColor)
		: m_centerX(centerX)
		, m_centerY(centerY)
...
void renderEffect(Image* output, double elapsedTime)
{
	...
	CirclePerPixelTestRenderer circleRenderer(centerX, centerY, radius, FloatRGBColor(255.f, 255.f, 255.f));
