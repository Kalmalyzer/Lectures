...
int ptc_open(wchar_t *title,int width,int height)
{
    ...
    AppendMenu(system_menu, MF_STRING, SC_ZOOM_1x1, L"Zoom 1 x 1");
    AppendMenu(system_menu, MF_STRING, SC_ZOOM_2x2, L"Zoom 2 x 2");
    AppendMenu(system_menu, MF_STRING, SC_ZOOM_4x4, L"Zoom 4 x 4");
