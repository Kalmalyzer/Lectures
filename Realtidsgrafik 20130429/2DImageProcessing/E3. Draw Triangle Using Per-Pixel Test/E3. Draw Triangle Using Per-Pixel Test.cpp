...
{
public:
	TrianglePerPixelTestRenderer(float x0, float y0, float x1, float y1, float x2, float y2, FloatRGBColor insideColor)
		: m_edge0(x0, y0, x1, y1)
		, m_edge1(x1, y1, x2, y2)
		, m_edge2(x2, y2, x0, y0)
...
void renderEffect(Image* output, double elapsedTime)
{
	...
	TrianglePerPixelTestRenderer triangleRenderer(x0, y0, x1, y1, x2, y2, FloatRGBColor(255.f, 255.f, 255.f));
