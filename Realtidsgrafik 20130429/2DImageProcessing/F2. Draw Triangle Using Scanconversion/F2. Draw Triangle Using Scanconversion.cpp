...
{
public:
	TriangleScanConversionRenderer(float x0, float y0, float x1, float y1, float x2, float y2, FloatRGBColor insideColor)
		: m_line0(x0, y0, x1, y1)
		, m_line1(x1, y1, x2, y2)
		, m_line2(x2, y2, x0, y0)
		, m_isRight0(y1 > y0)
...
void renderEffect(Image* output, double elapsedTime)
{
	...
	TriangleScanConversionRenderer triangleRenderer(x0, y0, x1, y1, x2, y2, FloatRGBColor(255.f, 255.f, 255.f));
